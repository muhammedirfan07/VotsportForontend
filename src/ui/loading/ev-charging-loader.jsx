...
export default function EVChargingLoader() {
  const [messageIndex, setMessageIndex] = useState(0) // State to manage the current message index
  ...
  }, []) // Dependency array ensures this effect runs once on mount and cleans up
