...
// import { SectionRail } from "../../../components/users/About";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className="relative mx-auto max-w-[1600px] px-6 lg:px-10 py-24 grid lg:grid-cols-12 gap-10 w-full">
      ...
      <section id="team" className="border-t border-border bg-card/30">
        <div className="mx-auto max-w-[1600px] px-6 lg:px-10 py-28 grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-12 rounded-2xl border border-primary/40 p-8 flex flex-wrap items-center justify-between gap-6 glow-green">
              <div>
                <div className="text-mono text-primary">Status / open</div>
                <div className="mt-2 text-2xl font-semibold">
                  Open to fresher MERN roles & collaborations.
                </div>
              </div>
              <Link
                to="/contact"
