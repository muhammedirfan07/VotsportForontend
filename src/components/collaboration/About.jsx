  ...
  return (
    <>
      ...
      <section id="network" className="relative min-h-[92vh] overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1600px] px-6 lg:px-10 pt-24 pb-24 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border px-6 py-3 text-sm hover:border-primary hover:text-primary transition"
              >
                Become a partner
              </button>
            </div>
