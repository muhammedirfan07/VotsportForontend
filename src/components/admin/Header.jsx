...
const Header = () => {
  ...
  return (
    <div className="relative mb-4 md:mb-6">
      <div className="flex font-[Manrope] justify-between bg-gradient-to-t from-gray-800 to-black py-3 md:py-4 px-3 md:px-4 rounded-b-xl items-center">
        <h1 className="text-lg sm:text-xl md:text-2xl md:ps-5 ps-12 font-bold text-white">Admin Pages!</h1>
