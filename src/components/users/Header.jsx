        ...
        <div className="hidden md:flex items-center space-x-6 text-md">
          {!isloging ? (
            <>
              ...
              <button onClick={() => navigate("/homecolab")} className="text-sm cursor-pointer text-muted-foreground hover:text-primary">Partners</button>
          ...
          <ul className="flex flex-col gap-1 p-3">
            {!isloging ? (
              <>
                ...
                <button onClick={() => navigate("/homecolab")} className="hover:bg-muted justify-center cursor-pointer text-sm rounded-xl px-2 py-2 text-muted-foreground hover:text-foreground transition-all ease-in-out text-left">Partners</button>
